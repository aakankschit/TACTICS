...
def main():
    ...
    aldehydes, aldehydes_names, acids, acids_names, coupled_aa, coupled_aa_names = get_bb_data(
        '/dfs9/dmobley-lab/anandkeo/TS_library_search/input_files/aldehydes_input.smi',
        '/dfs9/dmobley-lab/anandkeo/TS_library_search/input_files/acids_input.smi',
          '/dfs9/dmobley-lab/anandkeo/TS_library_search/input_files/coupled_aa_input.smi'
    )
    ...
    # Setup output
    output_dir = '/dfs9/dmobley-lab/anandkeo/TS_library_search/input_files/enum_lib'
