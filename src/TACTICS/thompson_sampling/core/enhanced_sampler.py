...
from ..legacy.reagent import Enhanced_TS_Reagent
...
class EnhancedThompsonSampler:
    def __init__(self, 
        ...
        self.reagent_lists: List[List[Enhanced_TS_Reagent]] = []
        self.reaction = None
        self.evaluator = None
        self.num_prods = 0
    ...
    def read_reagents(self, reagent_file_list, num_to_select: Optional[int] = None):
        ...
        :return: None
        """
        self.reagent_lists = read_reagents(reagent_file_list, ts_mode = "enhanced", num_to_select=num_to_select)
    ...
    def search(self, percent_of_library: float, 
        ...
        percent_of_library = self.percent_lib
        stop = self.search_stop
        min_cpds_per_core = self.min_cpds_per_core
        # results_filename is passed as parameter, don't override it
